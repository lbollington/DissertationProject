...
public class DentalHistoryAdapter extends RecyclerView.Adapter<DentalHistoryAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.DentistName.setText(document.DentistName);
        ...
        Glide.with(holder.AppName.getContext()).load(holder.imageurl.getText().toString()).into(holder.imageView);
    }
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder {
        TextView AppName, DentistName, Day, Month, Year, imageurl, PatientName;
        ImageView imageView;
